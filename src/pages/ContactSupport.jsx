export function ContactSupport() {
    return (
        <form className={"grid content-center py-8 place-items-center bg-white rounded-md lg:shadow-xl lg:px-8"}>
            ...
            <div className="mt-3 mb-3 flex items-center justify-end gap-x-6">
                ...
                <button
                    type="submit"
                    className="rounded-md bg-cyan-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                    Envoyer
                </button>
            </div>
